...
-- Optimized nvim-cmp setup with performance considerations
...
cmp.setup({
   ...
   experimental = {
      ghost_text = false, -- Can be distracting
   },
...
-- Note: Auto pairs is handled by mini.pairs in the main plugin config