...
# Docker Neovim Test Environment Launcher
...
run_container() {
    ...
    docker run -it --rm \
        ...
        -v "$DOTFILES_DIR/nvim/.config/nvim:/home/nvimuser/.config/nvim" \
        "$IMAGE_NAME"
}
...
show_help() {
    echo "Docker Neovim Test Environment"
    echo ""
    ...
    echo "  $0 run /path/to/project          # Run with specific workspace"
