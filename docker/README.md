# Docker Neovim Test Environment
...
- **Your exact configuration** mounted from `nvim/.config/nvim/`
...
./docker/docker-nvim.sh run /path/to/your/project

# Check Neovim health
./docker/docker-nvim.sh health

# Clean up (remove Docker image)
./docker/docker-nvim.sh clean
```
